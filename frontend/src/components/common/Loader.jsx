...
const loadingSteps = [
  ...
  { text: "ඔබට ගැලපෙන ආහාර රටාව සකස් කරමින් පවතී...", icon: "🥗", time: 10000 },
  { text: "ඔබට තේරෙන භාෂාවට පරිවර්තනය කරමින් පවතී...", icon: "✍️", time: 15000 },
  { text: "ඔබගේ වාර්තාව සූදානම් කරමින් පවතී, කරුණාකර රැඳී සිටින්න...", icon: "⏳", time: 22000 }
];
